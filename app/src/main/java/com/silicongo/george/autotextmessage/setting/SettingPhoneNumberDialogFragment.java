 ...
 */
public class SettingPhoneNumberDialogFragment extends DialogFragment {
    private EditText editText;

    private static final String TAG = "SettingPhoneNumberDialogFragment";
    public static final String PHONE_NUMBER = "SettingPhoneNumberDialogFragment.PHONE_NUMBER";

    private SettingPhoneNumberDialogFragment mInstance;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            editText.setText(getArguments().getString(PHONE_NUMBER));
        } else {
            editText.setText("");
        }
